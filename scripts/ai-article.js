...
สำคัญมาก: ห้ามใช้ JSON หรือ array ใน content — content ต้องเป็นข้อความภาษาไทยล้วน ไม่มีโครงสร้างซ้อน

Return ONLY valid JSON (no markdown, no code blocks):
{
  "title": "บทวิเคราะห์ทองคำประจำวันที่ ${today}",
  "content": "ข้อความภาษาไทยล้วน กระชับ ตรงประเด็น แบ่งเป็นหัวข้อตามด้านบน"
}`;
