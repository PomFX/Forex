...
async function initDB() {
  ...
  try {
    ...
    if (parseInt(contactExists.rows[0].count) === 0) {
      await client.query(`INSERT INTO site_settings (key, value) VALUES ('contact', '{"line_id":"@athtrader","phone":"","email":"contact@athtrader.com","qr_code":"","facebook":"","website":"","tiktok":"","youtube":""}')`);
    }
